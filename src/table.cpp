...
Table::Table()
    ...
    , boxes_origin_{
          ...
          GLVector<XYZW>(-inner_table_length_ / 2 - border_width_ / 2, 0,
                         inner_table_height_ + border_height_ / 2, 0),
          // BottomBorder
...
void Table::short_border() {
  // Left - top
  GLVector<XYZW> top_left = GLVector<XYZW>(
      -inner_table_length_ / 2 - border_width_, inner_table_width_ / 2,
      inner_table_height_ + border_height_ + plank_height_, 1);
  GLVector<XYZW> bottom_left = GLVector<XYZW>(
      -inner_table_length_ / 2 - border_width_, -inner_table_width_ / 2,
      inner_table_height_ + border_height_ + plank_height_, 1);
  GLVector<XYZW> bottom_right
      = GLVector<XYZW>(-inner_table_length_ / 2, -inner_table_width_ / 2,
                       inner_table_height_ + border_height_ + plank_height_, 1);
...
void Table::long_border() {
  ...
  GLVector<XYZW> bottom_left = GLVector<XYZW>(
      -inner_table_length_ / 2 - border_width_, inner_table_width_ / 2,
      inner_table_height_ + border_height_ + plank_height_, 1);
  GLVector<XYZW> bottom_right = GLVector<XYZW>(
      inner_table_length_ / 2 + border_width_, inner_table_width_ / 2,
      inner_table_height_ + border_height_ + plank_height_, 1);
  GLVector<XYZW> top_right
      = GLVector<XYZW>(inner_table_length_ / 2 + border_width_,
...
void Table::plank() {
  ...
  GLVector<XYZW> top_left
      = GLVector<XYZW>(-inner_table_length_ / 2, inner_table_width_ / 2,
                       inner_table_height_ + plank_height_, 1);
...
void Table::legs() {
  ...
  // TopLeft - ground
  GLVector<XYZW> top_left = GLVector<XYZW>(
      -inner_table_length_ / 2, inner_table_width_ / 2 - border_width_, 0, 1);
  GLVector<XYZW> bottom_left
      = GLVector<XYZW>(-inner_table_length_ / 2, inner_table_width_ / 2, 0, 1);
  GLVector<XYZW> bottom_right = GLVector<XYZW>(
      -inner_table_length_ / 2 + border_width_, inner_table_width_ / 2, 0, 1);
  GLVector<XYZW> top_right
      = GLVector<XYZW>(-inner_table_length_ / 2 + border_width_,
                       inner_table_width_ / 2 - border_width_, 0, 1);
  face(top_left, bottom_left, bottom_right, top_right);
